...
This is the repo for the Degen Labs mint pass. If you want to test this repo locally or create your own minter, you'll need to do the following:
...
REACT_APP_ALCHEMY_KEY = https://eth-rinkeby.alchemyapi.io/v2/<alchemy-key>
```
